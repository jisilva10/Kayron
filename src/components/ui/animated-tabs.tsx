...
return (
  <div className={cn("w-full max-w-lg flex flex-col gap-y-1", className)}>
    ...
    <div className="p-4 bg-[#11111198] shadow-[0_0_20px_rgba(0,0,0,0.2)] text-white bg-opacity-50 backdrop-blur-sm rounded-xl border border-gray-800 min-h-60 h-full">
